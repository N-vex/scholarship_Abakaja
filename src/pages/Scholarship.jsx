...
const links = [{ name: "Check Requirements", href: "#requirements" }];
          ...
          <section className="py-16 px-4 sm:py-20 ">
            <div className="max-w-4xl mx-auto text-white">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <p className="mb-3 text-body">
                  This is without prejudice to the fact that candidates could
                  access opportunities for international scholarships via the
                  foundation in any country of the world.
                </p>
              </div>
              <strong>
                <p
              ...
              <p className="mb-3 text-body">
                ...
                prominent Churches within the town and electronically via social
                media. The form shall be completed and re-submitted in record
                time. Only the shortlisted candidates shall be contacted for
                interview by the Foundation Board. The list of successful
                candidates shall be announced and published accordingly.
              </p>
            </div>
          </section>
